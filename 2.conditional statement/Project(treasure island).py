...
step_1=input('You\'re at a crossroad. Where do you want to go? Type "left" or "right"\')\'You\'re at a crossroad. Where do you want to go? Type "left" or "right" ').lower()
if step_1=="left":
    step_2=input('You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across.').lower()
    if step_2=="wait":
        step_3=input("You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose?").lower()
        if step_3=="red":
